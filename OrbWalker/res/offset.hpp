...
constexpr uptr oGetPing          = 0x510470;
constexpr uptr oPrintChat        = 0x8C4F00;
constexpr uptr oIssueOrder       = 0x965B20;
constexpr uptr oIssueMove        = 0x950E00;
constexpr uptr oAttackDelay      = 0x407B20;
constexpr uptr oTargetableToTeam = 0xAFE8C0;
constexpr uptr oMaterialRegistry = 0xF54390;
